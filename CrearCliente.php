                      ...
                      <tr align="center">
                        <td width="800" height="524" align="center" valign="top">                                              
							...
							<table width="700" border="0" align="center">
							  ...
							  <tr>
							    <td height="39%" align="center">&nbsp;</td>
							    <td align="left"><input name="nombre_representante" maxlength="100" type="text" id="nombre_representante" size="40" <?php if(!empty($ver_contactos) && $ver_contactos == '1'){ ?> value="<?php echo $cliente->nombre_representante; ?>" <?php  } ?> onKeyPress="javascript:return Letras(event)"></td>
							    <td align="left">&nbsp;</td>
