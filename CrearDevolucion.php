...
<script> 
var miPopup 
function abreVentanaReparacion(val1,val3){
	//alert(val1+' '+val2);
	miPopup = window.open("CrearReparacion.php? usu="+val1+"&var="+val3+"","miwin","width=600,height=510,scrollbars=yes") 
	miPopup.focus() 
}
</script>
</head>
						...
						if(sizeof($resp1)!=0){ ?>
						  <?php
							...
							<tr align="left" class="TablaUsuarios">
	                          ...
	                          <td width="46" align="center" valign="middle"><a onclick="abreVentanaReparacion('<?php echo $equi->id; ?>','<?php $_SESSION["id_eq_dev"]= $equipo->id; ?>','<?php echo $bus_rem->id; ?>');"><img src="imagenes/reparacion.png" width="25" height="25" /></a></td>
